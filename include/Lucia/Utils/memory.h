#ifndef MIKUS_LUCIA_UTILS_MEMORY_H_INCLUDED
#define MIKUS_LUCIA_UTILS_MEMORY_H_INCLUDED
#include <memory>
...
namespace Lucia
{
    ...
    template <class T>
    class sharedptr_from_this : virtual public MultipleInheritableEnableSharedFromThis
    {
    public:
