#ifndef MIKUS_LUCIA_GRAPHICS_TEXT_H
#define MIKUS_LUCIA_GRAPHICS_TEXT_H
...
#include <Lucia/Graphics/Shaders/Bloom.h> // for glow!
...
class Graphics::Text
{
    public:
        ...
        Text(){};
        // non virtuals
        void setProjection(Maths::Matrix<4>* projection);
    ...
    private:
        ...
        Maths::Matrix<4>* projection=nullptr;
        bool fixedGap=false;
        float wrapWidth = -1;
        float gapSize=0;
